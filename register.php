                ...
                <div class="card" style="border-radius: 15px;">
                    ...
                    <form method="post" action="register.php">
                        ...
                        <div class="form-outline mb-4 input-group">
                            ...
                            <input type="text" id="name" name="username" value="<?php echo $username; ?>" class="form-control form-control-lg" />
                        </div>

                        <div class="form-outline mb-4 input-group">
                            <label class="form-label" for="email">Email</label>
                            <input type="email" id="email" name="email" value="<?php echo $email; ?>" class="form-control form-control-lg" />
                        </div>
